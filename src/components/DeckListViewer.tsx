      ...
      {open && (
        <div className="border-t border-white/[0.04] px-4 py-4">
          {leaderCard && (
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider">Leader</p>
          ...
          <div className="mt-4 text-center text-xs text-gray-500 sm:text-sm">
            {enrichedCards.length} different cards · {totalCards} total
          </div>
        </div>
      )}
