...
import { Card, DeckCard } from '@/proxy-print/types';
import { optcgAPI } from '@/proxy-print/services/api';
import { debounce } from '@/proxy-print/utils/performance';
        ...
        {showDropdown && searchResults.length > 0 && (
          <div className="autocomplete-dropdown">
            {searchResults.map((card, index) => (
              ...
              >
                <img 
                  src={proxyImageUrl(card.image_uris.small || card.image_uris.large)} 
                  alt={card.name}
      ...
      {selectedCard && (
        <div className="selected-card-preview">
          <div className="selected-card-image-wrapper">
            <img 
              src={proxyImageUrl(selectedCard.image_uris.large || selectedCard.image_uris.small)} 
